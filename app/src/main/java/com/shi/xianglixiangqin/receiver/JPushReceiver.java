package com.shi.xianglixiangqin.receiver;
...
public class JPushReceiver extends BroadcastReceiver {
	...
	public static final String MESSAGE_RECEIVED_ACTION = "com.shi.xianglixiangqin.MESSAGE_RECEIVED_ACTION";
	@Override
	public void onReceive(Context context, Intent intent) {
        Bundle bundle = intent.getExtras();
        
		Log.e("MyReceiver", "接受到广播");
