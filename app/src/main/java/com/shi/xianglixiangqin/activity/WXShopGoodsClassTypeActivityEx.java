 ...
 *
 */
public class WXShopGoodsClassTypeActivityEx extends MyBaseActivity implements OnConnectServerStateListener<Integer>, SwipeRefreshLayout.OnRefreshListener {
		...
		public void onBindViewHolder(final MyViewHolder holder, final int position) {
			holder.itemView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent intent = new Intent(mContext,WXShopGoodsManageActivity.class);
