...
import com.shi.xianglixiangqin.pager.SportSaleBuyCrazyPager;
 ...
 * 2016年3月10日 16:56:10
 */
public class SportSaleBuyCrazyActivity extends MyBaseActivity implements OnConnectServerStateListener<Integer> {
	/**左侧返回按钮**/
	...
	/** 右侧旋转动画 **/
	@BindView(R.id.cb_saleTypeSelect)
	 CheckBox cb_saleTypeSelect;
	/** viewPager **/
	@BindView(R.id.viewPager)
	 ViewPager viewPager;
	/**页面数据**/
    private List<SportSaleBuyCrazyPager> listData_pagers;
    /**适配器**/
    private MyPagerAdapter pagerAdapter;
    /**当前活动类型为整点秒杀**/
	public final int currentPlatformActionType = 1;
	...
	public void initView() {
		...
		tv_title.setText(R.string.title_sportSaleBuyCrazyActivity);
		...
		listData_pagers = new ArrayList<SportSaleBuyCrazyPager>();
	...
	private void refreshShopSportView(){
		...
		SportSaleBuyCrazyPager basePager = new SportSaleBuyCrazyPager(this);
	...
	private void showPopWindow(){
		View contentView = View.inflate(mContext, R.layout.item_pop_select_sport_type, null);
    ...
    class MyPagerAdapter extends PagerAdapter{
        ...
        public Object instantiateItem(ViewGroup container, int position) {
        	SportSaleBuyCrazyPager currentPager = listData_pagers.get(position);
