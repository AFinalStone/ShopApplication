...
public class WXShopGoodsManageActivity extends MyBaseActivity implements
	...
	/** 批量加价控件 **/
	@BindView(R.id.btn_addToSpecialPricesGoods)
	...
	public void initData() {
		...
		MenuCreator creator = new MenuCreator() {
			...
			public void create(Menu menu) {
				...
				openItem.setTitle(R.string.cancelSettingSpecialPrices);
	...
	public void onClick(View v) {
		...
		case R.id.btn_sorting:
			if ("筛选".equals(btn_sorting.getText())) {
				...
				intent = new Intent(this, WXShopGoodsClassTypeActivityEx.class);
	...
	public void connectServiceFailed(String returnStrError, String methodName, Integer state,
		...
		if (methodName == InformationCodeUtil.methodNameBatchSetTjProducts) {
			ToastUtil.show(this, "网络异常,商品设置失败");
			return;
		}
