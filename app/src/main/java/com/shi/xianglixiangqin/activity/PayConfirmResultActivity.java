...
public class PayConfirmResultActivity extends MyBaseActivity {
    ...
    @BindView(R.id.iv_confirmOrderResultDesc)
    ImageView iv_confirmOrderResultDesc;

    @BindView(R.id.tv_confirmOrderResultDesc)
    TextView tv_confirmOrderResultDesc;

    @BindView(R.id.tv_continueToShopping)
    TextView tv_continueToShopping;

    @BindView(R.id.linearLayout_continueToShopping)
    LinearLayout linearLayout_continueToShopping;

    @BindView(R.id.iv_continueToMyOrder)
    ImageView iv_continueToMyOrder;

    @BindView(R.id.tv_continueToMyOrder)
    TextView tv_continueToMyOrder;

    @BindView(R.id.linearLayout_continueToMyOrder)
    LinearLayout linearLayout_continueToMyOrder;

    @BindView(R.id.iv_continueToConfirmOrder)
    ImageView iv_continueToConfirmOrder;

    @BindView(R.id.tv_continueToConfirmOrder)
    TextView tv_continueToConfirmOrder;

    @BindView(R.id.linearLayout_continueToConfirmOrder)
