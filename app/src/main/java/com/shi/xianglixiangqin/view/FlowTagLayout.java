...
public class FlowTagLayout extends ViewGroup {
    ...
    public interface OnItemSelectedListener {
        ...
        void onNothingSelected(View view, int position, long id);
    }
    ...
    private void reloadData() {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            final int currentSelectPosition = i;
            ...
            if(oldSelectPosition == currentSelectPosition){
                ...
                public void onClick(View v) {
                        if (oldSelectPosition == currentSelectPosition) {
                            ...
                            if (mOnItemSelectedListener != null) {
                                mOnItemSelectedListener.onNothingSelected(childView, currentSelectPosition, childView.getId());
                            }
                        }else{
                            ...
                            childView.setSelected(true);
                            if (mOnItemSelectedListener != null) {
                                mOnItemSelectedListener.onItemSelected(childView, currentSelectPosition, childView.getId());
                            }
                        }
                }
            });
    ...
    public void setCurrentSelectView(int position){
        if (oldSelectPosition != position) {
            ...
            if(mAdapter.getView(position, null, this) != null){
                mAdapter.getView(position, null, this).setSelected(true);
            }
        }
    }
