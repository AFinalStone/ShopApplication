...
/**
 * 带有自定义标题和和内容，以及一个确定按钮的Dialog
 * @author SHI
 * 2016年4月6日 15:19:39
 */
public class FragmentOkDialog extends android.support.v4.app.DialogFragment implements OnKeyListener
{
	String strTitle = "提示";
	String strMessage = "";
	String strOk = "确定";
	...
	public void initView(String strTitle, String strMessage, String strOk, OnButtonClickListener onButtonClickListener){
