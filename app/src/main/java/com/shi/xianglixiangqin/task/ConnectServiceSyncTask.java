...
public class ConnectServiceSyncTask{
	 ...
	 */
	public ConnectServiceSyncTask(Activity mContext, SoapObject requestSoapObject, String methodName) {
		super();
	...
	public  String connectCustomService(){
		returnSoapObject = ConnectServiceUtil.connectCustomService(requestSoapObject, methodName, connectOutTime);
		String returnString = returnSoapObject.getPropertyAsString(methodName+RESULT);
		return returnString;
	}
	...
	public String connectGoodsService(){
		returnSoapObject = ConnectServiceUtil.connectGoodsService(requestSoapObject, methodName, connectOutTime);
		String returnString = returnSoapObject.getPropertyAsString(methodName+RESULT);
		return returnString;
	}
