...
public class SelectPackageModel implements Serializable{
	/**套餐颜色数据**/
	private GoodsPackageStandardModel mPackageColorModel;
	/**套餐数据**/
	...
	public SelectPackageModel(GoodsPackageStandardModel mPackageColorModel,
	...
	public GoodsPackageStandardModel getmPackageColorModel() {
		return mPackageColorModel;
	}
	public void setmPackageColorModel(GoodsPackageStandardModel mPackageColorModel) {
		this.mPackageColorModel = mPackageColorModel;
	}
