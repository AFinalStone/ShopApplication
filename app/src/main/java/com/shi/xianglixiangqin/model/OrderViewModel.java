...
public class OrderViewModel implements Serializable
{
    ...
    /// <summary>订单状态(状态1:待支付,3:待发货,4:待收货,9:已完成,-1:已关闭)</summary>
    ...
    private int UserID;
    private double JEUseTotal;
    private long JFUseTotal;
    ...
    public double getJEUseTotal() {
        return JEUseTotal;
    }

    public void setJEUseTotal(double JEUseTotal) {
        this.JEUseTotal = JEUseTotal;
    }

    public long getJFUseTotal() {
        return JFUseTotal;
    }

    public void setJFUseTotal(long JFUseTotal) {
        this.JFUseTotal = JFUseTotal;
    }
}
