...
//	private String ImgPath;
    ...
    private double MaxCorePrice;
    private double MinCorePrice;
    /**
     * 最大价格
     **/
    ...
    //为了兼容组合商品而添加的字段
    private List<GoodsGeneralModel> Zgoods;
    private double MaxYhje;
    private double MinYhje;
    private List<GoodsPackageModel> Zgcolorpackages;
...
//	}
    ...
    public double getMaxCorePrice() {
        return MaxCorePrice;
    }

    public void setMaxCorePrice(double maxCorePrice) {
        MaxCorePrice = maxCorePrice;
    }

    public double getMinCorePrice() {
        return MinCorePrice;
    }

    public void setMinCorePrice(double minCorePrice) {
    ...
    public List<GoodsGeneralModel> getZgoods() {
        return Zgoods;
    }

    public void setZgoods(List<GoodsGeneralModel> zgoods) {
        Zgoods = zgoods;
    }

    public double getMaxYhje() {
        return MaxYhje;
    }

    public void setMaxYhje(double maxYhje) {
        MaxYhje = maxYhje;
    }

    public double getMinYhje() {
        return MinYhje;
    }

    public void setMinYhje(double minYhje) {
        MinYhje = minYhje;
    }

    public List<GoodsPackageModel> getZgcolorpackages() {
        return Zgcolorpackages;
    }

    public void setZgcolorpackages(List<GoodsPackageModel> zgcolorpackages) {
        Zgcolorpackages = zgcolorpackages;
    }

    public String getMaybeGetJF() {
        return MaybeGetJF;
    }

    public void setMaybeGetJF(String maybeGetJF) {
        MaybeGetJF = maybeGetJF;
    }
}
