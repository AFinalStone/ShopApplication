...
public class CustomModel {
	...
	/**当前浏览店铺ID**/
	private int currentBrowsingShopID;
//	/**当前登录店铺店主用户ID**/
...
//	private String loginShopName;
	...
	public int getCurrentBrowsingShopID() {
		return currentBrowsingShopID;
	}

	public void setCurrentBrowsingShopID(int currentBrowsingShopID) {
		this.currentBrowsingShopID = currentBrowsingShopID;
	}
}
