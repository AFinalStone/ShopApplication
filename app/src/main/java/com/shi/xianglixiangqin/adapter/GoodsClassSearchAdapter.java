...
public class GoodsClassSearchAdapter extends MyBaseAdapter<GoodsGeneralModel> implements OnConnectServerStateListener<GoodsGeneralModel> {
	...
	public void addGoodsToCacheData(GoodsGeneralModel productModel) {
		...
		GoodsPackageStandardModel tempPackageColor = productModel.getDefaultGoodsPackage().getDefaultPackageColor();
	...
	@Override
	public void connectServiceFailed(String returnStrError, String methodName, GoodsGeneralModel state, boolean whetherRefresh) {
		ToastUtil.show(mContext,"网络异常，加入购物车失败");
	}
