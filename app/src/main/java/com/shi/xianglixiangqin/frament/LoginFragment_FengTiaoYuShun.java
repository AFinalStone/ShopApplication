...
public class LoginFragment_FengTiaoYuShun extends LoginBaseFragment {
    ...
    @OnClick({R.id.btn_login, R.id.tv_forgotPassword
            , R.id.iv_clearUserNumber, R.id.tv_titleRight})
