 ...
 * @action 登陆
 * @author SHI
 * @date 2017-1-5 10:43:53
 */

public class LoginFragment_HaiJiaoWangLuo extends LoginBaseFragment{
	...
	public View initView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragment_login_haijiaowangluo, container, false);
