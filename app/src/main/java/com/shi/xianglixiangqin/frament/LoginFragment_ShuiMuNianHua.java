...
public class LoginFragment_ShuiMuNianHua extends LoginBaseFragment{
	...
	public View initView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragment_login_shuimunianhua, container, false);
	...
	@OnClick({R.id.btn_login, R.id.tv_register, R.id.tv_forgotPassword, R.id.iv_clearUserNumber})
