...
import com.shuimunianhua.xianglixiangqin.activity.ThemeTypeActivity;
...
import com.shuimunianhua.xianglixiangqin.model.AdvertisementModel;
...
import com.shuimunianhua.xianglixiangqin.view.SelectCityPopWindow;
...
public class MainHomeFragment_DaiNiFei extends MyBaseFragment<MainActivity> implements
	...
	/**选择城市战的界面**/
	private SelectCityPopWindow pop;
	/** 搜索内容 **/
	...
	/** 团购中心 **/
	@Bind(R.id.linearLayout_goodsByGroupBuy)
	...
	/** 更多限时抢购商品 **/
	@Bind(R.id.linearLayout_moreSalesByTimeLimited)
	...
	/**主题街外围的控件**/
	@Bind(R.id.tv_themeType)
	 TextView tv_themeType;
	/** 主题街gridview_border01 **/
	@Bind(R.id.gridView_themeType01)
	...
	/** 主题街gridView02 **/
	@Bind(R.id.gridView_themeType02)
	...
	/**好店推荐**/
	@Bind(R.id.tv_niceShopPush)
	 TextView tv_niceShopPush;
	/** 好店推荐gridView **/
	@Bind(R.id.gridView_niceShopPush)
	...
	/** 更多新品推荐 **/
	@Bind(R.id.tv_moreNewGoodsData)
	 TextView tv_moreNewGoodsData;
	/** 新品推荐gridView **/
	@Bind(R.id.gridView_newGoodsPush)
	...
	@Bind(R.id.iv_advertisement_01)
	ImageView iv_advertisement_01;

	@Bind(R.id.iv_advertisement_02)
...
//		pop = new PopupWindow(contentView, LayoutParams.WRAP_CONTENT, popHeight, true);
		pop = new SelectCityPopWindow(mActivity, LayoutParams.MATCH_PARENT, popHeight, true);
//		pop = new SelectCityLocationPop(mActivity,LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, true, null);
	...
	public void onClick(View v) {
		...
		case R.id.btn_search:
			...
			intent.putExtra(InformationCodeUtil.IntentSearchGoodsInFromBottom, true);
			mActivity.startActivity(intent);
