...
public class PasswordChangeSecoundActivity extends MyBaseActivity implements OnConnectServerStateListener<Integer>{
	...
	public void initView() {
		setContentView(R.layout.activity_password_change_secound);
	...
	public void initData() {
		...
		tv_title.setText(R.string.passwordChangeSecoundTitle);
	...
	public void connectServiceFailed(String methodName, Integer state,
		...
		ToastUtils.show(mContext, "网络异常,修改密码失败");
	}
