...
public class OtherOrderActivity extends MyBaseActivity implements OnSwipeRefreshViewListener{
    ...
    public void initView() {
        ...
        orderAdapter = new OrderAdapter(mContext, listData);
     ...
     *         2016-2-17 15:41:48
     */
    public class OrderAdapter extends MyBaseAdapter<OrderViewModel> {

        public OrderAdapter(Context mContext, List<OrderViewModel> listData) {
...
//                                    changeOrderStateToHaveFinish(""+mOrderViewModel.getDjLsh());
                            ...
                            dialog.show(OtherOrderActivity.this.getSupportFragmentManager(),"dialog");
                        }
                    });
                    viewHolderParent.linearLayout_accountOrderState.setVisibility(View.VISIBLE);
                    if (mOrderViewModel.getDelayPayDays() == 0) {
