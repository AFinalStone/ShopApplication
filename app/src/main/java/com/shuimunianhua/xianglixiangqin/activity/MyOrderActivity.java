...
import com.shuimunianhua.xianglixiangqin.pager.MyOrderGeneralPager;
import com.shuimunianhua.xianglixiangqin.pager.MyOrderToPayPager;
...
public class MyOrderActivity extends MyBaseActivity{
	...
	public void initData() {
		...
		viewPager.postDelayed(new Runnable() {
			@Override
			public void run() {
				tabIndicatorView.setCurrentSelectItem(1);
