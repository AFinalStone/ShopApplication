 ...
 *  2016-2-1 11:40:57
 */
public class LoginJvHeActivity extends MyBaseActivity{
	...
	/** 登陆店铺编号 **/
	@Bind(R.id.et_userLoginShopID)
	 EditText et_userLoginShopID;
	/** 登陆按钮 **/
	@Bind(R.id.btn_login)
	Button btn_login;
	...
	LoginJvHeActivityController mLoginActivityController;
	...
	private OnTextChangeListener textChangeListener = new OnTextChangeListener() {
		...
		public void afterTextChanged(Editable s) {
			...
			&& !StringUtil.isEmpty(et_userLoginShopID.getText().toString().trim()))
			{
	...
	public void initView() {
		setContentView(R.layout.activity_login_jvhe);
		ButterKnife.bind(this);
		setReturnStatu(true);

		et_userNumber.addTextChangedListener(textChangeListener);
		et_userPassword.addTextChangedListener(textChangeListener);
		et_userLoginShopID.addTextChangedListener(textChangeListener);
	}

	@Override
	public void initData() {
		mLoginActivityController = new LoginJvHeActivityController(this);
	...
	public String getUserCodeOfEnterShop() {
		return et_userLoginShopID.getText().toString();
	}
	...
	public void toMainView(int loginShopID) {
