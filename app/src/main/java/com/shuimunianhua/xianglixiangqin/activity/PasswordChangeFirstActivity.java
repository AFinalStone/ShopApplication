 ...
 * @action 修改密码第一步
 * @author SHI
 * @date  2016年5月3日 10:42:03
 */
public class PasswordChangeFirstActivity  extends MyBaseActivity implements OnClickListener, OnConnectServerStateListener<Integer>{
	...
	public void initView() {
		...
		tv_title.setText(R.string.passwordChangeFirstTitle);
	...
	public void onClick(View v) {
		...
		case R.id.btn_nextStep:
			if(checkUserMsg())
			{
				Intent intent = new Intent(mContext,PasswordChangeSecoundActivity.class);
