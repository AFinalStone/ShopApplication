 ...
 */
public class SplashActivityControllerImpJvHe extends SplashActivityController {
	...
	public SplashActivityControllerImpJvHe(SplashActivity mSplashActivity) {
		super();
...
//		String urlVersionDesc = InformationCodeUtil.urlVersionDesc_JvHe;
		String urlVersionDesc = InformationCodeUtil.urlVersionDesc_ShuiMuNianHua;
        OkHttpUtils.get()
		   .url(urlVersionDesc)
		   .build()
		   .connTimeOut(3000)
	    	...
	    	new Thread(){
	    		public void run() {
	    			SystemClock.sleep(SLEEPTIME-lengTime);
						mSplashActivity.toLoginView_JvHe();
	    		};
	    	}.start();			
		}else{
				mSplashActivity.toLoginView_JvHe();
