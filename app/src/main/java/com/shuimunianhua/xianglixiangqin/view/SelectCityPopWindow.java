...
import com.shuimunianhua.xianglixiangqin.pager.SelectCityLocationPager;
 ...
 * 2016年4月28日 16:11:17
 */
public class SelectCityPopWindow extends PopupWindow implements OnConnectServerStateListener<Integer> {
...
//	private ImageView iv_indicatorBottom;
	...
	public SelectCityPopWindow(Activity mContext, int width, int height,
			boolean focusable) {
...
//					(mMainActivity, this, requestSoapObject, methodName);
